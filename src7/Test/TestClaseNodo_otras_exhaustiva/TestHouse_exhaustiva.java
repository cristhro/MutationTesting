...
public class TestHouse_exhaustiva {
	...
	public void test() {
		...
		assertEquals(a.setDir(null),new House(figura3D, pos, "calle manuel luna").setDir(null));
		assertEquals(a.setPos(null),new House(figura3D, pos, "calle manuel luna").setPos(null));
		assertEquals(a.addFigura3D(null),new House(figura3D, pos, "calle manuel luna").addFigura3D(null));

		
		a=new House(null, null, null);
		assertEquals(a.getFigura3D(),a.getFigura3D());
		assertEquals(a.getPos(),a.getPos());
		assertEquals(a.setDir("calle velayos"),a.setDir("calle velayos"));
		assertEquals(a.setPos(new Posicion(333,444)),a.setPos(new Posicion(333,444)));
		assertEquals(a.addFigura3D(new Tetraedro(new Rectangulo(2, 13), 10)),a.addFigura3D(new  Tetraedro(new Rectangulo(2, 13), 10)));
